...
Si ce dernier a été effectué au CNRGH, alors les fichiers sont copiés et compressés.
...
Les fichiers de statistiques du run sont archivés par pistes et par types (.html, .fq.stat) avant d'être copiés vers leurs répertoires finales.
